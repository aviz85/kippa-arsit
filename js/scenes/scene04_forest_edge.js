  ...
  GAME.registerScene({
    ...
    hotspots:[
      ...
      { id:'stump', name:'הגזע', rect:{x:176,y:138,w:30,h:18}, near:{x:176,y:172},
        ...
        onTake(){ GAME.RED('לסחוב גזע שלם? אני ארסית, לא מלגזה.'); },
      ...
      { id:'logs', name:'ערימת הבולים', rect:{x:240,y:118,w:60,h:38}, near:{x:250,y:172},
        ...
        onTake(){
          if(helped()){ GAME.RED('יש לי כבר קרש. כמה עץ ארסית צריכה? אני לא בונה ספינה.'); return; }
      ...
      { id:'sign', name:'השלט', rect:{x:138,y:96,w:30,h:18}, near:{x:152,y:172},
        ...
        onTake(){ GAME.RED('לתלוש שלט עירוני? אני ארסית עם ערכים. אספלט נגמר, ערכים לא.'); },
